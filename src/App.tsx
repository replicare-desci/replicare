          ...
          >
            <Container maxWidth="xl">
              ...
              <Typography variant="h5" color="text.secondary" paragraph>
                ...
                reproductions that are conducted but may otherwise go
                unpublished. Computational reproducibility is the ability to
                reproduce the results, tables, and other figures found in
                research articles using the data, code, and materials made
              ...
              <section>
                ...
                <Typography variant="h5" color="text.secondary" paragraph>
                  ...
                  This lack of incentives for larger-scale reproduction audits
                  is due to a lack of journal publishing. To address these
                  issues efficiently, there needs to be a reevaluation on how we
                  perform, reward, and communicate results from reproductions.
                </Typography>
              </section>
              <section>
                <Typography
                ...
                <Typography variant="h5" color="text.secondary" paragraph>
                  ...
                  <List>
                    ...
                    <ListItem>
                      <ListItemText>
                        {" "}
                        2. [Scoping] Define the scope of the exercise by
                        recording the claims, display items, and specifications
                        you will focus on in the remainder of the reproduction{" "}
                      </ListItemText>
                    </ListItem>
                    <ListItem>
                      <ListItemText>
                  ...
                  <Typography variant="h6" component={"p"}>
                    ...
                    nuanced approach to reproducibility, where reproducers
                    analyse individual claims and their associated display
                    items, and take concrete steps to improve their
                    reproducibility. Reproduction reports are transparent and
                    publicly document their analyses to support collaboration,
                    discussion, and reuse. These reports can be anonymously
                    shared.
                  </Typography>
                </Typography>
              </section>
